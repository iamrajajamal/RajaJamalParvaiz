...
export function HeroSection() {
  ...
  const techTags = [
    { name: "Unity 3D", color: "bg-craft-red/10 text-craft-red border-craft-red/30" },
    { name: "Multiplayer Systems", color: "bg-craft-blue/10 text-craft-blue border-craft-blue/30" },
    { name: "Project Management", color: "bg-craft-brown/10 text-craft-brown border-craft-brown/30" },
    { name: "AR/VR", color: "bg-craft-green/10 text-craft-green border-craft-green/30" },
    { name: "Mobile & PC Games", color: "bg-craft-yellow/10 text-foreground border-craft-yellow/40" },
    { name: "WebGL", color: "bg-craft-red/15 text-craft-red border-craft-red/30" },
    { name: "Console Games", color: "bg-craft-blue/15 text-craft-blue border-craft-blue/30" },
  ];
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span className="relative inline-block text-primary">
                ...
                <svg className="absolute bottom-[-10px] left-0 w-full h-4 text-craft-yellow" fill="none" viewBox="0 0 100 10">
                  <path d="M 0 5 Q 50 1 100 5 Q 50 9 0 5" stroke="currentColor" strokeWidth="4" strokeLinecap="round" fill="none" />
                </svg>
              </span>
            </motion.h1>
            ...
            >
              Creating immersive interactive worlds. Specialized in core gameplay, production, and scalable systems.
            </motion.p>
          </div>
            ...
            <div className="flex flex-wrap gap-2.5 max-w-xl">
              {techTags.map((tech, index) => (
                <motion.div
                  ...
                  initial={{ opacity: 0, scale: 0.9, rotate: (Math.random() - 0.5) * 6 }}
            ...
            {photos.map((photo, index) => {
              ...
              return (
                ...
                >
                  ...
                  {!isBehind && (
                    <div className={`craft-tape craft-tape-top ${
                      index === 0 ? "tape-coral" : index === 1 ? "tape-blue" : "tape-green"
                    }`} />
                  )}
