...
export function AboutSection() {
  ...
  useMatterPhysics(badgesContainerRef, { 
    itemSelector: ".physics-badge",
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <div 
            ...
            className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-12 pl-6 md:pl-10 relative z-10 min-h-[300px] md:min-h-[160px]"
          >
            {badges.map((badge, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`physics-badge craft-panel p-4 flex flex-col items-center gap-3 bg-white border border-foreground/70 paper-shadow transition-all ${badge.color}`}
                >
